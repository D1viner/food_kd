...
if __name__ == "__main__":
    ...
    # 存放日志和模型的目录    
    pathlib.Path(f"./{model_name}_{dataset_name}").mkdir(parents=True, exist_ok=True)
    ...
    log_dir = f"./{model_name}_{dataset_name}/{model_name}_{dataset_name}_{time_str}_log"
    ...
    for epoch in range(EPOCH):
        ...
        if test_top1_acc > best_top1_acc:
            ...
            torch.save(model.state_dict(), f'./{model_name}_{dataset_name}/{model_name}_{epoch}.pth')
